...
const links = [
  ...
  { id: 1, name: 'CRM', href: '/navigation/crm', icon: UserPlusIcon },
  { id: 2, name: 'EDI Manager', href: '/navigation/edi', icon: ShoppingCartIcon },
  { id: 3, name: 'Human Relations', href: '/navigation/hr', icon: UserGroupIcon },
  { id: 4, name: 'Project Manager', href: '/navigation/pm', icon: RectangleGroupIcon },
  { id: 5, name: 'Warehouse Manager', href: '/navigation/wm', icon: TruckIcon },
